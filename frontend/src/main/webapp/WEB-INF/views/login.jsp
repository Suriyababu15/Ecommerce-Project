...
.body{
	...
	width: auto;
	height: auto;
	background-image: url(resources/login/gettyimages-653536234-2048x2048.jpg);
...
::-moz-input-placeholder{
   color: rgba(255,255,255,0.6);
    ...
    <div class="body"></div>
		<div class="grad"></div>
		<div class="header">
			<div>Log<span>In</span>EStore</div>
		</div>
		<br>
		<form action="isvaliduser" method="post">
	 <div class="login">
		
				<input type="text" placeholder="gmail" name="emailId" required><br>
